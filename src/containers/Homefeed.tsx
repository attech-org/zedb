...
const SubmitFormDiv = styled.div`
  padding: 12px 0px;
  display: flex;
...
const WrapperInputDiv = styled.div`
  display: flex;
  justify-content: flex-start;
  padding: 12px 0px;
`;
...
interface userInfoProps {
  userInfo: Array<userTypeObject>;
}
export const Homefeed: React.FC<userInfoProps> = ({ userInfo }) => {
  const [tweets, setTweets] = useState<Array<tweets>>([]);
        ...
        <InputField>
          ...
          <SubmitFormDiv>
            <IconsDiv>
              ...
              <CircleDiv>
                <Svg1 viewBox="0 0 24 24" aria-hidden="true">
                  <g>
